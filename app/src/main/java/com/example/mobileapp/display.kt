...
class display : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val getStartedButton1: Button = findViewById(R.id.radioButton2)
        getStartedButton1.setOnClickListener {
            // Create an Intent to start the NextActivity
            val intent = Intent(this, done_task::class.java)
            startActivity(intent)
        }

        val getStartedButton2: Button = findViewById(R.id.radioButton)
        ...
        val add: ImageView = findViewById(R.id.imageView27)
